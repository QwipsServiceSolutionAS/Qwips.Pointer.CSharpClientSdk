...
#nullable restore
        ...
        public async Task<InlineResponse2002Activities> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse2002Activities>(requestInfo, InlineResponse2002Activities.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Get Activity
        /// </summary>
