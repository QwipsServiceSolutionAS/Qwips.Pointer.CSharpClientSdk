...
#nullable restore
        ...
        public async Task<InlineResponse20044TenantUserRoles> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20044TenantUserRoles>(requestInfo, InlineResponse20044TenantUserRoles.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
