...
#nullable restore
        ...
        public async Task<InlineResponse20046TenantIntegrations> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20046TenantIntegrations>(requestInfo, InlineResponse20046TenantIntegrations.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Get Tenant Integration
        /// </summary>
