...
#nullable restore
        ...
        public async Task<InlineResponse20045TenantUsers> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20045TenantUsers>(requestInfo, InlineResponse20045TenantUsers.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Tenant User
        /// </summary>
