...
namespace Qwips.Core.Pointer.XrmAzureAdmin.V1.Tenants.Item.UserProxy.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \xrm-azure-admin\v1\tenants\{tenantId}\userProxy\{integrationId}
    /// </summary>
    public class WithIntegrationItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithIntegrationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/xrm-azure-admin/v1/tenants/{tenantId}/userProxy/{integrationId}{?apiPath*,filter*,top*,select*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithIntegrationItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithIntegrationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/xrm-azure-admin/v1/tenants/{tenantId}/userProxy/{integrationId}{?apiPath*,filter*,top*,select*}", rawUrl) {
        }
        /// <summary>
        /// Azure Graph API for current user
        /// </summary>
...
#nullable restore
        ...
        public async Task<string> DeleteAsync(Action<WithIntegrationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendPrimitiveAsync<string>(requestInfo, PointerErrorHandler.GenericErrorResponse, cancellationToken);
        }
        /// <summary>
        /// Azure Graph API for current user
        /// </summary>
