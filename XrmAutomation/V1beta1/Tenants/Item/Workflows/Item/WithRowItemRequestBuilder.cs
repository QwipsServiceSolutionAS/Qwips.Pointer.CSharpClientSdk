...
#nullable restore
        ...
        public async Task<InlineResponse2004Workflows> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse2004Workflows>(requestInfo, InlineResponse2004Workflows.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Workflow
        /// </summary>
