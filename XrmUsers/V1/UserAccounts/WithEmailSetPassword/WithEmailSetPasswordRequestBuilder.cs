...
#nullable restore
        ...
        public async Task<WithEmailSetPasswordResponse> PostAsync(Body116 body, Action<WithEmailSetPasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<WithEmailSetPasswordResponse>(requestInfo, WithEmailSetPasswordResponse.CreateFromDiscriminatorValue, PointerErrorHandler.GenericErrorResponse, cancellationToken);
        }
        /// <summary>
        /// Set password
        /// </summary>
