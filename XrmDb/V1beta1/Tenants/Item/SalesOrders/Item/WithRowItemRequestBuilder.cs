...
#nullable restore
        ...
        public async Task<InlineResponse20026SalesOrders> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20026SalesOrders>(requestInfo, InlineResponse20026SalesOrders.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Sales Order
        /// </summary>
