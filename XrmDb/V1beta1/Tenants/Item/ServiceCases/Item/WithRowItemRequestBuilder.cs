...
#nullable restore
        ...
        public async Task<InlineResponse20029ServiceCases> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20029ServiceCases>(requestInfo, InlineResponse20029ServiceCases.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Service Case
        /// </summary>
