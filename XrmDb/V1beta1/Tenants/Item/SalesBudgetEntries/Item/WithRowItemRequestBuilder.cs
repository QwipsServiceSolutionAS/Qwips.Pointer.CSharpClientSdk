...
#nullable restore
        ...
        public async Task<InlineResponse20022SalesBudgetEntries> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20022SalesBudgetEntries>(requestInfo, InlineResponse20022SalesBudgetEntries.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
