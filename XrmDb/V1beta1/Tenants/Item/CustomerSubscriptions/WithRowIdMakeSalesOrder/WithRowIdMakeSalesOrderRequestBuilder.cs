...
using System;
namespace Qwips.Core.Pointer.XrmDb.V1beta1.Tenants.Item.CustomerSubscriptions.WithRowIdMakeSalesOrder {
    /// <summary>
    ...
    public class WithRowIdMakeSalesOrderRequestBuilder : BaseRequestBuilder {
        ...
        public WithRowIdMakeSalesOrderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string rowId = "") : base(requestAdapter, "{+baseurl}/xrm-db/v1beta1/tenants/{tenantId}/customerSubscriptions/{rowId}:makeSalesOrder", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRowIdMakeSalesOrderRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/xrm-db/v1beta1/tenants/{tenantId}/customerSubscriptions/{rowId}:makeSalesOrder", rawUrl) {
        }
        /// <summary>
        /// Create sales order from subscription
        /// </summary>
...
#nullable enable
        public async Task<InlineResponse20064?> PostAsync(Body130 body, Action<WithRowIdMakeSalesOrderRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<InlineResponse20064> PostAsync(Body130 body, Action<WithRowIdMakeSalesOrderRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Body130 body, Action<WithRowIdMakeSalesOrderRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Body130 body, Action<WithRowIdMakeSalesOrderRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
