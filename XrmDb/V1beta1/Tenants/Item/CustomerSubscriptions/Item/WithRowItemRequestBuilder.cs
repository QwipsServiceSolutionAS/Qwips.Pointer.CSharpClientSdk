...
using Qwips.Core.Pointer.XrmDb.V1beta1.Tenants.Item.CustomerSubscriptions.Item.Associations;
using Qwips.Core.Pointer.XrmDb.V1beta1.Tenants.Item.CustomerSubscriptions.Item.OrderLines;
...
using System;
namespace Qwips.Core.Pointer.XrmDb.V1beta1.Tenants.Item.CustomerSubscriptions.Item {
    /// <summary>
    /// Builds and executes requests for operations under \xrm-db\v1beta1\tenants\{tenantId}\customerSubscriptions\{rowId}
    /// </summary>
    public class WithRowItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithRowItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/xrm-db/v1beta1/tenants/{tenantId}/customerSubscriptions/{rowId}{?rowIdKey*,includeFk*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithRowItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRowItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/xrm-db/v1beta1/tenants/{tenantId}/customerSubscriptions/{rowId}{?rowIdKey*,includeFk*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<InlineResponse20016CustomerSubscriptions?> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<InlineResponse20016CustomerSubscriptions> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<InlineResponse20016CustomerSubscriptions>(requestInfo, InlineResponse20016CustomerSubscriptions.CreateFromDiscriminatorValue, PointerErrorHandler.GenericErrorResponse, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProductUpdateResponse?> PatchAsync(Body59 body, Action<WithRowItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<InlineResponse2005> PatchAsync(Body59 body, Action<WithRowItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Body59 body, Action<WithRowItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Body59 body, Action<WithRowItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
