...
#nullable restore
        ...
        public async Task<InlineResponse20028ServiceActivities> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20028ServiceActivities>(requestInfo, InlineResponse20028ServiceActivities.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
