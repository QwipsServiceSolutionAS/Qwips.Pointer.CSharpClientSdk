...
#nullable restore
        ...
        public async Task<InlineResponse20031SignableDocuments> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20031SignableDocuments>(requestInfo, InlineResponse20031SignableDocuments.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
