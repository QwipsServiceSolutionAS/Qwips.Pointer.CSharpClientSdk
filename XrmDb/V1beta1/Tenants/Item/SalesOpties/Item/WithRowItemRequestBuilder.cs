...
#nullable restore
        ...
        public async Task<InlineResponse20024SalesOpties> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20024SalesOpties>(requestInfo, InlineResponse20024SalesOpties.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Sales Opty
        /// </summary>
