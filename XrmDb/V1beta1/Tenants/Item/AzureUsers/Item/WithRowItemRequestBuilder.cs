...
#nullable restore
        ...
        public async Task<InlineResponse20011AzureUsers> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20011AzureUsers>(requestInfo, InlineResponse20011AzureUsers.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Get Azure User
        /// </summary>
