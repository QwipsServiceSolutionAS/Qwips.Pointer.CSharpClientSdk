...
#nullable restore
        ...
        public async Task<InlineResponse20036SimplePriceLists> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20036SimplePriceLists>(requestInfo, InlineResponse20036SimplePriceLists.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
