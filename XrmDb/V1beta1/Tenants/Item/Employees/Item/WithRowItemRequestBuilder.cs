...
#nullable restore
        ...
        public async Task<InlineResponse2008Employees> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse2008Employees>(requestInfo, InlineResponse2008Employees.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Employee
        /// </summary>
