...
#nullable restore
        ...
        public async Task<InlineResponse20032Suppliers> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20032Suppliers>(requestInfo, InlineResponse20032Suppliers.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Supplier
        /// </summary>
