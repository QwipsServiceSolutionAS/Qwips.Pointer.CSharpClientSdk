...
#nullable restore
        ...
        public async Task<InlineResponse20020Products> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20020Products>(requestInfo, InlineResponse20020Products.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Product
        /// </summary>
