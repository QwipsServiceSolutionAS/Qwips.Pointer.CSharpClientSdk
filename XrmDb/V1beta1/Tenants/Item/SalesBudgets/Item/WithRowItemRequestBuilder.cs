...
#nullable restore
        ...
        public async Task<InlineResponse20023SalesBudgets> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20023SalesBudgets>(requestInfo, InlineResponse20023SalesBudgets.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Sales Budget
        /// </summary>
