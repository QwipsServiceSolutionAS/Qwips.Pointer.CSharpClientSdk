...
#nullable restore
        ...
        public async Task<InlineResponse20014ContactPersons> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20014ContactPersons>(requestInfo, InlineResponse20014ContactPersons.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
