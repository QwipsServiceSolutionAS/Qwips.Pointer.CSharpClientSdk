...
#nullable restore
        ...
        public async Task<InlineResponse20012Announcements> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20012Announcements>(requestInfo, InlineResponse20012Announcements.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Announcement
        /// </summary>
