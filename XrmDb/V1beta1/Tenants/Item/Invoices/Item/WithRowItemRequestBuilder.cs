...
#nullable restore
        ...
        public async Task<InlineResponse20019Invoices> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20019Invoices>(requestInfo, InlineResponse20019Invoices.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Invoice
        /// </summary>
