...
#nullable restore
        ...
        public async Task<InlineResponse2006BellNotifications> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse2006BellNotifications>(requestInfo, InlineResponse2006BellNotifications.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
