...
#nullable restore
        ...
        public async Task<InlineResponse20035VatGroups> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20035VatGroups>(requestInfo, InlineResponse20035VatGroups.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Vat Group
        /// </summary>
