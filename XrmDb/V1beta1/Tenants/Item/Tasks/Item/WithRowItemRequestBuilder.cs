...
#nullable restore
        ...
        public async Task<InlineResponse20034Tasks> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20034Tasks>(requestInfo, InlineResponse20034Tasks.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Task
        /// </summary>
