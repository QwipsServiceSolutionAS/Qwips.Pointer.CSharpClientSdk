...
#nullable restore
        ...
        public async Task<InlineResponse20018FileCollections> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20018FileCollections>(requestInfo, InlineResponse20018FileCollections.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
