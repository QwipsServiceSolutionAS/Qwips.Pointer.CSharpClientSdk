...
using Qwips.Core.Pointer.XrmDb.V1beta1.Tenants.Item.FileCollections.Item.Associations;
...
using System;
namespace Qwips.Core.Pointer.XrmDb.V1beta1.Tenants.Item.FileCollections.Item {
    /// <summary>
    /// Builds and executes requests for operations under \xrm-db\v1beta1\tenants\{tenantId}\fileCollections\{rowId}
    /// </summary>
    public class WithRowItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithRowItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/xrm-db/v1beta1/tenants/{tenantId}/fileCollections/{rowId}{?rowIdKey*,includeFk*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithRowItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRowItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/xrm-db/v1beta1/tenants/{tenantId}/fileCollections/{rowId}{?rowIdKey*,includeFk*}", rawUrl) {
        }
        /// <summary>
        /// Get File Collection
        /// </summary>
...
#nullable enable
        public async Task<InlineResponse20018FileCollections?> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<InlineResponse20018FileCollections> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<InlineResponse20018FileCollections>(requestInfo, InlineResponse20018FileCollections.CreateFromDiscriminatorValue, PointerErrorHandler.GenericErrorResponse, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProductUpdateResponse?> PatchAsync(Body57 body, Action<WithRowItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<InlineResponse2005> PatchAsync(Body57 body, Action<WithRowItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Body57 body, Action<WithRowItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Body57 body, Action<WithRowItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
