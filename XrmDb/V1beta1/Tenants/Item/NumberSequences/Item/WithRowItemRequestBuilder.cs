...
#nullable restore
        ...
        public async Task<InlineResponse2007NumberSequences> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse2007NumberSequences>(requestInfo, InlineResponse2007NumberSequences.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
