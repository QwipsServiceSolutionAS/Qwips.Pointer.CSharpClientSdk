...
#nullable restore
        ...
        public async Task<InlineResponse20027SalesQuotes> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20027SalesQuotes>(requestInfo, InlineResponse20027SalesQuotes.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Sales Quote
        /// </summary>
