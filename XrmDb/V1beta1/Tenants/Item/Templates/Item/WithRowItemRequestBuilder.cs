...
#nullable restore
        ...
        public async Task<InlineResponse20038Templates> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20038Templates>(requestInfo, InlineResponse20038Templates.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Template
        /// </summary>
