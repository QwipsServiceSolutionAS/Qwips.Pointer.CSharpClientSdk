...
#nullable restore
        ...
        public async Task<InlineResponse20030ServiceResources> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20030ServiceResources>(requestInfo, InlineResponse20030ServiceResources.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
