...
#nullable restore
        ...
        public async Task<InlineResponse20010Departments> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20010Departments>(requestInfo, InlineResponse20010Departments.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Department
        /// </summary>
