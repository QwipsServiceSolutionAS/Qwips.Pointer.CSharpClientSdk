...
#nullable restore
        ...
        public async Task<InlineResponse2009DriveItems> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse2009DriveItems>(requestInfo, InlineResponse2009DriveItems.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Update Drive Item
        /// </summary>
