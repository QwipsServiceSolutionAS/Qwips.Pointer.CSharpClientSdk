...
#nullable restore
        ...
        public async Task<InlineResponse20025SalesOrderCategories> GetAsync(Action<WithRowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InlineResponse20025SalesOrderCategories>(requestInfo, InlineResponse20025SalesOrderCategories.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
