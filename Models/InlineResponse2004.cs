...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse2004 : IParsable {
...
#nullable restore
        ...
        /// <summary>Gets or Sets Workflows</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse2004Workflows>? Workflows { get; set; }
#nullable restore
#else
        public List<InlineResponse2004Workflows> Workflows { get; set; }
#endif
        ...
        public static InlineResponse2004 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"workflows", n => { Workflows = n.GetCollectionOfObjectValues<InlineResponse2004Workflows>(InlineResponse2004Workflows.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse2004Workflows>("workflows", Workflows);
        }
    }
}
