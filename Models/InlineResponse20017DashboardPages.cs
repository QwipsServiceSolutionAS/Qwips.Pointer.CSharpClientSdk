...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20017DashboardPages : IParsable {
        /// <summary>Gets or Sets CreatedAt</summary>
        public DateTimeOffset? CreatedAt { get; set; }
        /// <summary>Gets or Sets DashviewComponentId</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? DashviewComponentId { get; set; }
#nullable restore
#else
        public string DashviewComponentId { get; set; }
#endif
...
#nullable restore
        ...
        public string Id { get; set; }
#endif
        /// <summary>Gets or Sets IframeSrc</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public static InlineResponse20017DashboardPages CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20017DashboardPages();
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("dashviewComponentId", DashviewComponentId);
            writer.WriteObjectValue<InlineResponse2004Hashes>("_hashes", Hashes);
            writer.WriteStringValue("id", Id);
            writer.WriteStringValue("iframeSrc", IframeSrc);
