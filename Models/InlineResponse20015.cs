...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20015 : IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse20015Customers>? Customers { get; set; }
#nullable restore
#else
        public List<InlineResponse20015Customers> Customers { get; set; }
#endif
...
#nullable restore
        ...
        public static InlineResponse20015 CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20015();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"customers", n => { Customers = n.GetCollectionOfObjectValues<InlineResponse20015Customers>(InlineResponse20015Customers.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse20015Customers>("customers", Customers);
