...
#nullable restore
        ...
        public Body27_plus_PricingTypeEnum? PricingType { get; set; }
        /// <summary>Gets or Sets Priority</summary>
        public Body27_plus_PriorityEnum? Priority { get; set; }
...
#nullable restore
        ...
        public Body27_plus_StatusPhaseEnum? StatusPhase { get; set; }
        /// <summary>Gets or Sets StatusProgress</summary>
        public Body27_plus_StatusProgressEnum? StatusProgress { get; set; }
...
#nullable restore
        ...
        public Body27_plus_TypeCategory1Enum? TypeCategory1 { get; set; }
...
#nullable restore
        ...
        public static Body27 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"pricingType", n => { PricingType = n.GetEnumValue<Body27_plus_PricingTypeEnum>(); } },
                {"priority", n => { Priority = n.GetEnumValue<Body27_plus_PriorityEnum>(); } },
                ...
                {"statusPhase", n => { StatusPhase = n.GetEnumValue<Body27_plus_StatusPhaseEnum>(); } },
                {"statusProgress", n => { StatusProgress = n.GetEnumValue<Body27_plus_StatusProgressEnum>(); } },
                {"taskCollectionId", n => { TaskCollectionId = n.GetStringValue(); } },
                {"typeCategory1", n => { TypeCategory1 = n.GetEnumValue<Body27_plus_TypeCategory1Enum>(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<Body27_plus_PricingTypeEnum>("pricingType", PricingType);
            writer.WriteEnumValue<Body27_plus_PriorityEnum>("priority", Priority);
            ...
            writer.WriteEnumValue<Body27_plus_StatusPhaseEnum>("statusPhase", StatusPhase);
            writer.WriteEnumValue<Body27_plus_StatusProgressEnum>("statusProgress", StatusProgress);
            writer.WriteStringValue("taskCollectionId", TaskCollectionId);
            writer.WriteEnumValue<Body27_plus_TypeCategory1Enum>("typeCategory1", TypeCategory1);
