...
#nullable restore
        ...
        public Body69_plus_TenantAccessLevelEnum? TenantAccessLevel { get; set; }
        /// <summary>Gets or Sets UserEntityType</summary>
        public Body69_plus_UserEntityTypeEnum? UserEntityType { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Body69 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"tenantAccessLevel", n => { TenantAccessLevel = n.GetEnumValue<Body69_plus_TenantAccessLevelEnum>(); } },
                {"userEntityType", n => { UserEntityType = n.GetEnumValue<Body69_plus_UserEntityTypeEnum>(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<Body69_plus_TenantAccessLevelEnum>("tenantAccessLevel", TenantAccessLevel);
            writer.WriteEnumValue<Body69_plus_UserEntityTypeEnum>("userEntityType", UserEntityType);
        }
    }
}
