...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Body48_persistedPdfGenOptions? PersistedPdfGenOptions { get; set; }
#nullable restore
#else
        public Body48_persistedPdfGenOptions PersistedPdfGenOptions { get; set; }
#endif
...
#nullable restore
        ...
        public Body48_plus_QuoteStatusEnum? QuoteStatus { get; set; }
...
#nullable restore
        ...
        public static Body48 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"persistedPdfGenOptions", n => { PersistedPdfGenOptions = n.GetObjectValue<Body48_persistedPdfGenOptions>(Body48_persistedPdfGenOptions.CreateFromDiscriminatorValue); } },
                {"projectId", n => { ProjectId = n.GetStringValue(); } },
                {"quoteEmailSentAt", n => { QuoteEmailSentAt = n.GetDateTimeOffsetValue(); } },
                {"quoteStatus", n => { QuoteStatus = n.GetEnumValue<Body48_plus_QuoteStatusEnum>(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Body48_persistedPdfGenOptions>("persistedPdfGenOptions", PersistedPdfGenOptions);
            writer.WriteStringValue("projectId", ProjectId);
            writer.WriteDateTimeOffsetValue("quoteEmailSentAt", QuoteEmailSentAt);
            writer.WriteEnumValue<Body48_plus_QuoteStatusEnum>("quoteStatus", QuoteStatus);
