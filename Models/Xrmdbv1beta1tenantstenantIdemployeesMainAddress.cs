...
namespace Qwips.Core.Pointer.Models {
    public class Xrmdbv1beta1tenantstenantIdemployeesMainAddress : IParsable {
...
#nullable restore
        ...
        public static Xrmdbv1beta1tenantstenantIdemployeesMainAddress CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Xrmdbv1beta1tenantstenantIdemployeesMainAddress();
        }
        /// <summary>
