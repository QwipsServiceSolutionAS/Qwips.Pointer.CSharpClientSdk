...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Body44_signantResponseDump? SignantResponseDump { get; set; }
#nullable restore
#else
        public Body44_signantResponseDump SignantResponseDump { get; set; }
#endif
...
#nullable restore
        ...
        public Body44_plus_SigningProviderEnum? SigningProvider { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Body44_templateContext? TemplateContext { get; set; }
#nullable restore
#else
        public Body44_templateContext TemplateContext { get; set; }
#endif
...
#nullable restore
        ...
        public static Body44 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"signantResponseDump", n => { SignantResponseDump = n.GetObjectValue<Body44_signantResponseDump>(Body44_signantResponseDump.CreateFromDiscriminatorValue); } },
                ...
                {"signingProvider", n => { SigningProvider = n.GetEnumValue<Body44_plus_SigningProviderEnum>(); } },
                {"signKey", n => { SignKey = n.GetStringValue(); } },
                {"templateContext", n => { TemplateContext = n.GetObjectValue<Body44_templateContext>(Body44_templateContext.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Body44_signantResponseDump>("signantResponseDump", SignantResponseDump);
            ...
            writer.WriteEnumValue<Body44_plus_SigningProviderEnum>("signingProvider", SigningProvider);
            writer.WriteStringValue("signKey", SignKey);
            writer.WriteObjectValue<Body44_templateContext>("templateContext", TemplateContext);
