...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20014ContactPersons : IParsable {
...
#nullable restore
        ...
        public static InlineResponse20014ContactPersons CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20014ContactPersons();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"contactPersonType", n => { ContactPersonType = n.GetStringValue(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("contactPersonType", ContactPersonType);
