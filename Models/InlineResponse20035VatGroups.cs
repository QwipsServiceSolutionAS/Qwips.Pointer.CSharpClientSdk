...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20035VatGroups : IParsable {
...
#nullable restore
        ...
        public double? VatRatePct { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static InlineResponse20035VatGroups CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20035VatGroups();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"vatRatePct", n => { VatRatePct = n.GetDoubleValue(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteDoubleValue("vatRatePct", VatRatePct);
        }
    }
}
