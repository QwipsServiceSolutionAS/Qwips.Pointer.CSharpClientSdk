...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20032 : IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse20032Suppliers>? Suppliers { get; set; }
#nullable restore
#else
        public List<InlineResponse20032Suppliers> Suppliers { get; set; }
#endif
        ...
        public static InlineResponse20032 CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20032();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"suppliers", n => { Suppliers = n.GetCollectionOfObjectValues<InlineResponse20032Suppliers>(InlineResponse20032Suppliers.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse20032Suppliers>("suppliers", Suppliers);
