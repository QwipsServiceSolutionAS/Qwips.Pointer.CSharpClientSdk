...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse2003 : IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse2003Notes>? Notes { get; set; }
#nullable restore
#else
        public List<InlineResponse2003Notes> Notes { get; set; }
#endif
        ...
        public static InlineResponse2003 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"notes", n => { Notes = n.GetCollectionOfObjectValues<InlineResponse2003Notes>(InlineResponse2003Notes.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse2003Notes>("notes", Notes);
