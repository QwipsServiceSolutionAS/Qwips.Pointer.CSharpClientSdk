...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20024 : IParsable {
...
#nullable restore
        ...
        public string NextPageToken { get; set; }
#endif
        /// <summary>Gets or Sets SalesOpties</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse20024SalesOpties>? SalesOpties { get; set; }
#nullable restore
#else
        public List<InlineResponse20024SalesOpties> SalesOpties { get; set; }
#endif
        ...
        public static InlineResponse20024 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"salesOpties", n => { SalesOpties = n.GetCollectionOfObjectValues<InlineResponse20024SalesOpties>(InlineResponse20024SalesOpties.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse20024SalesOpties>("salesOpties", SalesOpties);
