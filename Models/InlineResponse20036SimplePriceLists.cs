...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20036SimplePriceLists : IParsable {
...
#nullable restore
        ...
        public static InlineResponse20036SimplePriceLists CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20036SimplePriceLists();
        }
        /// <summary>
