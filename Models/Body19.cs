...
#nullable restore
        ...
        public Body19_plus_InvoiceTypeEnum? InvoiceType { get; set; }
...
#nullable restore
        ...
        public Body19_plus_OrderStatusEnum? OrderStatus { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Body19_persistedPdfGenOptions? PersistedPdfGenOptions { get; set; }
#nullable restore
#else
        public Body19_persistedPdfGenOptions PersistedPdfGenOptions { get; set; }
#endif
...
#nullable restore
        ...
        public static Body19 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"invoiceType", n => { InvoiceType = n.GetEnumValue<Body19_plus_InvoiceTypeEnum>(); } },
                ...
                {"orderStatus", n => { OrderStatus = n.GetEnumValue<Body19_plus_OrderStatusEnum>(); } },
                {"ourContactId", n => { OurContactId = n.GetStringValue(); } },
                {"persistedPdfGenOptions", n => { PersistedPdfGenOptions = n.GetObjectValue<Body19_persistedPdfGenOptions>(Body19_persistedPdfGenOptions.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<Body19_plus_InvoiceTypeEnum>("invoiceType", InvoiceType);
            ...
            writer.WriteEnumValue<Body19_plus_OrderStatusEnum>("orderStatus", OrderStatus);
            writer.WriteStringValue("ourContactId", OurContactId);
            writer.WriteObjectValue<Body19_persistedPdfGenOptions>("persistedPdfGenOptions", PersistedPdfGenOptions);
