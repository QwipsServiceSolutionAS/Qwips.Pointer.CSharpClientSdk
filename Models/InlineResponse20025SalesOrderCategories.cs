...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20025SalesOrderCategories : IParsable {
...
#nullable restore
        ...
        public static InlineResponse20025SalesOrderCategories CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20025SalesOrderCategories();
        }
        /// <summary>
