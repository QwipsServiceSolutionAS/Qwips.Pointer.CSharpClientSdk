...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20023SalesBudgets : IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? SalesBudgetType { get; set; }
#nullable restore
#else
        public string SalesBudgetType { get; set; }
#endif
...
#nullable restore
        ...
        public static InlineResponse20023SalesBudgets CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20023SalesBudgets();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"salesBudgetType", n => { SalesBudgetType = n.GetStringValue(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("salesBudgetType", SalesBudgetType);
