...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20018FileCollections : IParsable {
        /// <summary>Gets or Sets AppliesToEntityType</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? AppliesToEntityType { get; set; }
#nullable restore
#else
        public string AppliesToEntityType { get; set; }
#endif
...
#nullable restore
        ...
        public static InlineResponse20018FileCollections CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20018FileCollections();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"appliesToEntityType", n => { AppliesToEntityType = n.GetStringValue(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("appliesToEntityType", AppliesToEntityType);
