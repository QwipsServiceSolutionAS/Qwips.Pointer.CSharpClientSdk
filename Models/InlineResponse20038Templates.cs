...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20038Templates : IParsable {
...
#nullable restore
        ...
        public static InlineResponse20038Templates CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20038Templates();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"templateCategory", n => { TemplateCategory = n.GetStringValue(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("templateCategory", TemplateCategory);
