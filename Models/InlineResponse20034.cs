...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20034 : IParsable {
...
#nullable restore
        ...
        public string NextPageToken { get; set; }
#endif
        /// <summary>Gets or Sets Tasks</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse20034Tasks>? Tasks { get; set; }
#nullable restore
#else
        public List<InlineResponse20034Tasks> Tasks { get; set; }
#endif
        ...
        public static InlineResponse20034 CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20034();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"tasks", n => { Tasks = n.GetCollectionOfObjectValues<InlineResponse20034Tasks>(InlineResponse20034Tasks.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse20034Tasks>("tasks", Tasks);
