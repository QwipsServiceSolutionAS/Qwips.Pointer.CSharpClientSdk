...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse2002Activities : IParsable {
...
#nullable restore
        ...
        public static InlineResponse2002Activities CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse2002Activities();
        }
        /// <summary>
