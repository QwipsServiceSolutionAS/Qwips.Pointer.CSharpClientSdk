...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20038 : IParsable {
...
#nullable restore
        ...
        public string NextPageToken { get; set; }
#endif
        /// <summary>Gets or Sets Templates</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse20038Templates>? Templates { get; set; }
#nullable restore
#else
        public List<InlineResponse20038Templates> Templates { get; set; }
#endif
        ...
        public static InlineResponse20038 CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20038();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"templates", n => { Templates = n.GetCollectionOfObjectValues<InlineResponse20038Templates>(InlineResponse20038Templates.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse20038Templates>("templates", Templates);
