...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20013Assets : IParsable {
...
#nullable restore
        ...
        public static InlineResponse20013Assets CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20013Assets();
        }
        /// <summary>
