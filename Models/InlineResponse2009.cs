...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse2009 : IParsable {
...
#nullable restore
        ...
        public InlineResponse2002Aggs Aggs { get; set; }
#endif
        /// <summary>Gets or Sets DriveItems</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse2009DriveItems>? DriveItems { get; set; }
#nullable restore
#else
        public List<InlineResponse2009DriveItems> DriveItems { get; set; }
#endif
...
#nullable restore
        ...
        public static InlineResponse2009 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"driveItems", n => { DriveItems = n.GetCollectionOfObjectValues<InlineResponse2009DriveItems>(InlineResponse2009DriveItems.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse2009DriveItems>("driveItems", DriveItems);
