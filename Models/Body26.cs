...
namespace Qwips.Core.Pointer.Models {
    public class Body26 : IParsable {
        /// <summary>Gets or Sets AppliesToEntityType</summary>
        public Body26_plus_AppliesToEntityTypeEnum? AppliesToEntityType { get; set; }
...
#nullable restore
        ...
        public static Body26 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"appliesToEntityType", n => { AppliesToEntityType = n.GetEnumValue<Body26_plus_AppliesToEntityTypeEnum>(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<Body26_plus_AppliesToEntityTypeEnum>("appliesToEntityType", AppliesToEntityType);
