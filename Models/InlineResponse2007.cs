...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse2007 : IParsable {
...
#nullable restore
        ...
        public string NextPageToken { get; set; }
#endif
        /// <summary>Gets or Sets NumberSequences</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse2007NumberSequences>? NumberSequences { get; set; }
#nullable restore
#else
        public List<InlineResponse2007NumberSequences> NumberSequences { get; set; }
#endif
        ...
        public static InlineResponse2007 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"numberSequences", n => { NumberSequences = n.GetCollectionOfObjectValues<InlineResponse2007NumberSequences>(InlineResponse2007NumberSequences.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse2007NumberSequences>("numberSequences", NumberSequences);
