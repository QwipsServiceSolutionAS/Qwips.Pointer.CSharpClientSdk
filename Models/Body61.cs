...
namespace Qwips.Core.Pointer.Models {
    public class Body61 : IParsable {
        /// <summary>Gets or Sets ContactPersonType</summary>
        public Body61_plus_ContactPersonTypeEnum? ContactPersonType { get; set; }
...
#nullable restore
        ...
        public static Body61 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"contactPersonType", n => { ContactPersonType = n.GetEnumValue<Body61_plus_ContactPersonTypeEnum>(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<Body61_plus_ContactPersonTypeEnum>("contactPersonType", ContactPersonType);
