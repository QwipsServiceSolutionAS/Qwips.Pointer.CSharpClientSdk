...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20055SmsProviderInfo : IParsable {
...
#nullable restore
        ...
        public static InlineResponse20055SmsProviderInfo CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20055SmsProviderInfo();
        }
        /// <summary>
