...
namespace Qwips.Core.Pointer.Models {
    public class Body135 : IParsable {
        /// <summary>Gets or Sets Decision</summary>
        public Body135_plus_DecisionEnum? Decision { get; set; }
...
#nullable restore
        ...
        public static Body135 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"decision", n => { Decision = n.GetEnumValue<Body135_plus_DecisionEnum>(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<Body135_plus_DecisionEnum>("decision", Decision);
