...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse2008 : IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse2008Employees>? Employees { get; set; }
#nullable restore
#else
        public List<InlineResponse2008Employees> Employees { get; set; }
#endif
...
#nullable restore
        ...
        public static InlineResponse2008 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"employees", n => { Employees = n.GetCollectionOfObjectValues<InlineResponse2008Employees>(InlineResponse2008Employees.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse2008Employees>("employees", Employees);
