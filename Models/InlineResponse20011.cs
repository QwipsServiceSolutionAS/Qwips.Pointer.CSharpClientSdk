...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20011 : IParsable {
...
#nullable restore
        ...
        public InlineResponse2002Aggs Aggs { get; set; }
#endif
        /// <summary>Gets or Sets AzureUsers</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse20011AzureUsers>? AzureUsers { get; set; }
#nullable restore
#else
        public List<InlineResponse20011AzureUsers> AzureUsers { get; set; }
#endif
...
#nullable restore
        ...
        public static InlineResponse20011 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"azureUsers", n => { AzureUsers = n.GetCollectionOfObjectValues<InlineResponse20011AzureUsers>(InlineResponse20011AzureUsers.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse20011AzureUsers>("azureUsers", AzureUsers);
