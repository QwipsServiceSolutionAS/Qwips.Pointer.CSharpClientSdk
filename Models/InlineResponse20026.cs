...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20026 : IParsable {
...
#nullable restore
        ...
        public string NextPageToken { get; set; }
#endif
        /// <summary>Gets or Sets SalesOrders</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<InlineResponse20026SalesOrders>? SalesOrders { get; set; }
#nullable restore
#else
        public List<InlineResponse20026SalesOrders> SalesOrders { get; set; }
#endif
        ...
        public static InlineResponse20026 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"salesOrders", n => { SalesOrders = n.GetCollectionOfObjectValues<InlineResponse20026SalesOrders>(InlineResponse20026SalesOrders.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<InlineResponse20026SalesOrders>("salesOrders", SalesOrders);
