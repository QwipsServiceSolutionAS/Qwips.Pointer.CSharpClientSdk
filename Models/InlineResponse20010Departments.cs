...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20010Departments : IParsable {
...
#nullable restore
        ...
        public static InlineResponse20010Departments CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20010Departments();
        }
        /// <summary>
