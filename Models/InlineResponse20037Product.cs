...
namespace Qwips.Core.Pointer.Models {
    public class InlineResponse20037Product : IParsable {
...
#nullable restore
        ...
        public static InlineResponse20037Product CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InlineResponse20037Product();
        }
        /// <summary>
